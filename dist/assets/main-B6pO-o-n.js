(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function t(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(n){if(n.ep)return;n.ep=!0;const a=t(n);fetch(n.href,a)}})();document.addEventListener("DOMContentLoaded",()=>{const e=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(N(),e){D();return}R(),Y(),X(),$(),z(),V(),H(),U(),W(),j(),G(),_()});function N(){const e=document.createElement("style");e.textContent=`
  ...
  `,document.head.appendChild(e)}function D(){document.querySelectorAll("#hero dl dt").forEach(t=>{t.style.transform="none"});const r=document.querySelector("#about");if(r){r.querySelectorAll(".char-rollup-target").forEach(i=>i.style.transform="none"),r.querySelectorAll(".space-y-6 > p").forEach(i=>{i.style.filter="none",i.style.opacity="1",i.style.transform="none"}),r.querySelectorAll(".flex.flex-wrap.gap-2.text-xs span").forEach(i=>{i.style.opacity="1",i.style.transform="none"});const a=document.getElementById("about-portrait");a&&(a.style.opacity="1",a.style.transform="none");const c=document.getElementById("about-tagline-container");c&&(c.style.opacity="1",c.style.transform="none")}}function R(){const e=document.querySelector("#hero h1");if(!e)return;e.classList.add("clip-reveal");let r=0;const t=.06;function o(n){if(n.nodeType===Node.TEXT_NODE){const c=n.nodeValue.split(/(\s+)/),i=document.createDocumentFragment();c.forEach(l=>{if(l.trim().length>0){const s=document.createElement("span");s.className="animate-word",s.textContent=l,s.style.animationDelay=`${r*t}s`,i.appendChild(s),r++}else i.appendChild(document.createTextNode(l))}),n.parentNode.replaceChild(i,n)}else n.nodeType===Node.ELEMENT_NODE&&n.tagName!=="SVG"&&Array.from(n.childNodes).forEach(o)}Array.from(e.childNodes).forEach(o)}function Y(){const e=document.querySelector('header a[href="#hero"]');if(!e)return;const r=e.querySelector(".bg-primary"),t=e.querySelector(".text-primary");if(!t||!r)return;const o="Nocode",n="Savvy";let a=!1;e.addEventListener("mouseenter",()=>{if(a)return;a=!0;const c="ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789",i=performance.now(),l=600,s=30;function f(d){const u=d-i;let p="";for(let g=0;g<o.length;g++){const v=g*s;u>=l||u>=v+(l-o.length*s)?p+=o[g]:p+=c[Math.floor(Math.random()*c.length)]}let m="";for(let g=0;g<n.length;g++){const v=(o.length+g)*s;u>=l||u>=v+(l-(o.length+n.length)*s)?m+=n[g]:m+=c[Math.floor(Math.random()*c.length)]}let h=r.nextSibling;h&&h.nodeType===Node.TEXT_NODE&&(h.nodeValue=p),t.textContent=m,u<l?requestAnimationFrame(f):(h&&h.nodeType===Node.TEXT_NODE&&(h.nodeValue=o),t.textContent=n,a=!1)}requestAnimationFrame(f)})}function X(){const e=document.querySelectorAll("h1, h2, h3"),r=[];e.forEach(o=>{const n=o.textContent.trim();n.split(/\s+/).length<=3&&(o.classList.add("gradient-wipe"),o.setAttribute("data-text",n),r.push(o))});const t=new IntersectionObserver(o=>{o.forEach(n=>{n.isIntersecting&&(n.target.classList.add("wipe-active"),t.unobserve(n.target))})},{threshold:.5});r.forEach(o=>t.observe(o))}function $(){const e=document.getElementById("typewriter-text");if(!e)return;const r=["SaaS platforms that scale.","Bubble apps that don't break.","AI integrations that actually work.","Payment systems wired right.","MVPs shipped in 3 weeks.","The thing your business actually needs."];let t=0,o=0,n=!1;setTimeout(()=>{a()},1400);function a(){const c=r[t];n?(e.textContent=c.substring(0,o-1),o--,o===0?(n=!1,t=(t+1)%r.length,setTimeout(a,550)):setTimeout(a,30)):(e.textContent=c.substring(0,o+1),o++,o===c.length?(n=!0,setTimeout(a,1600)):setTimeout(a,55))}}function z(){const e=document.querySelectorAll(".underline-sweep-target");if(e.length===0)return;const r=new IntersectionObserver(t=>{t.forEach(o=>{o.isIntersecting&&(o.target.classList.add("sweep-active"),r.unobserve(o.target))})},{threshold:.3});e.forEach(t=>r.observe(t))}function V(){const e=document.querySelector("#about");if(!e)return;const r=e.querySelectorAll(".char-rollup-target"),t=[],o="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!@#$%^&*()_+";r.forEach(s=>{const f=s.textContent.trim();s.innerHTML="",s.classList.add("char-roll-container");const d=[];for(let u=0;u<f.length;u++){const p=f[u];if(p===" "){const m=document.createElement("span");m.className="char-roll-char",m.innerHTML="&nbsp;",s.appendChild(m)}else{const m=document.createElement("span");m.className="char-roll-col";const h=10;for(let v=0;v<h;v++){const y=document.createElement("span");y.className="char-roll-char",y.textContent=o[Math.floor(Math.random()*o.length)],m.appendChild(y)}const g=document.createElement("span");g.className="char-roll-char",g.textContent=p,m.appendChild(g),s.appendChild(m),d.push({col:m,index:u})}}t.push({columns:d,target:s})});const n=e.querySelectorAll(".space-y-6 > p");n.forEach(s=>s.classList.add("about-bio-p"));const a=e.querySelectorAll(".flex.flex-wrap.gap-2.text-xs span");a.forEach(s=>s.classList.add("about-badge-item"));const c=document.getElementById("about-portrait"),i=new IntersectionObserver(s=>{s.forEach(f=>{if(f.isIntersecting){if(t.forEach(({columns:d})=>{d.forEach(({col:u,index:p})=>{setTimeout(()=>{u.style.transform=`translateY(-${10*1.2}em)`},p*35)})}),n.forEach((d,u)=>{setTimeout(()=>{d.classList.add("reveal-active")},u*180)}),a.forEach((d,u)=>{setTimeout(()=>{d.classList.add("reveal-active")},u*120)}),c){c.classList.add("reveal-active");const d=document.getElementById("about-tagline-container");d&&d.classList.add("reveal-active"),setTimeout(()=>{c.classList.add("portrait-pulse-active")},900)}i.unobserve(f.target)}})},{threshold:.15});i.observe(e),e.querySelectorAll(".about-magnetic-card").forEach(s=>{s.addEventListener("mousemove",f=>{const d=s.getBoundingClientRect(),u=d.left+d.width/2,p=d.top+d.height/2,m=f.clientX,h=f.clientY,g=m-u,v=h-p,y=g/d.width*16,E=v/d.height*16,L=Math.sqrt(y*y+E*E),x=8;let I=y,C=E;L>x&&(I=y/L*x,C=E/L*x),s.style.transition="none",s.style.transform=`translate(${I}px, ${C}px)`}),s.addEventListener("mouseleave",()=>{s.style.transition="transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",s.style.transform="translate(0px, 0px)"})})}function H(){const e=document.querySelectorAll("#work .grid a");if(e.length===0)return;e.forEach(t=>{t.classList.add("curtain-card");const o=document.createElement("div");o.className="curtain-overlay",t.appendChild(o)});const r=new IntersectionObserver(t=>{let o=0;t.forEach(n=>{if(n.isIntersecting){const a=n.target;setTimeout(()=>{a.classList.add("wipe-active")},o*120),o++,r.unobserve(a)}})},{threshold:.2});e.forEach(t=>r.observe(t))}function U(){const e=document.querySelectorAll("#problem .grid > div"),r=document.querySelectorAll("#what-i-build .grid > div");[...e,...r].forEach(o=>{o.classList.add("draw-border-card");const n=document.createElement("span");n.className="draw-border-line draw-border-top";const a=document.createElement("span");a.className="draw-border-line draw-border-right";const c=document.createElement("span");c.className="draw-border-line draw-border-bottom";const i=document.createElement("span");i.className="draw-border-line draw-border-left",o.appendChild(n),o.appendChild(a),o.appendChild(c),o.appendChild(i)})}function W(){const e=document.querySelector(".font-display.text-5xl"),r=document.querySelector(".font-display.text-3xl.text-primary"),t=document.querySelectorAll("input[type='range']");if(!e||!r||t.length<3)return;let o=0,n=0,a=!0;function c(d){return"$"+Math.round(d).toLocaleString()}function i(){const d=parseInt(t[0].value,10),u=parseInt(t[1].value,10),p=parseInt(t[2].value,10),m=d*u*p*52,h=m*.78;return{drain:m,recoverable:h}}function l(d=400){const{drain:u,recoverable:p}=i();s(e,o,u,d,c,' <span class="text-base text-muted-foreground">/ year</span>'),s(r,n,p,d,c,' <span class="text-base text-muted-foreground">/ year</span>'),o=u,n=p}function s(d,u,p,m,h,g){const v=performance.now();function y(E){const L=E-v,x=Math.min(L/m,1),I=x===1?1:1-Math.pow(2,-10*x),C=u+(p-u)*I;d.innerHTML=`${h(C)}${g}`,x<1?requestAnimationFrame(y):d.innerHTML=`${h(p)}${g}`}requestAnimationFrame(y)}t.forEach(d=>{d.addEventListener("input",()=>{l(400)})});const f=document.querySelector("#roi-calc")||document.querySelector("section[data-section='services'] + section");if(f){const d=new IntersectionObserver(u=>{u.forEach(p=>{if(p.isIntersecting&&a){a=!1;const{drain:m,recoverable:h}=i();o=m,n=h,s(e,0,m,1200,c,' <span class="text-base text-muted-foreground">/ year</span>'),s(r,0,h,1200,c,' <span class="text-base text-muted-foreground">/ year</span>'),d.unobserve(p.target)}})},{threshold:.1});d.observe(f)}}function j(){document.querySelectorAll(".faq-answer").forEach(r=>{const t=document.createElement("div");t.className="faq-answer-inner",t.innerHTML=r.innerHTML,r.innerHTML="",r.appendChild(t)})}function G(){const e=[document.querySelector("#toolkit .grid"),document.querySelector("#services .space-y-4"),document.querySelector("#process .rounded-2xl"),document.querySelector("#work-list tbody"),document.querySelector("#faq .space-y-4")||document.querySelector("#faq .border-t.hairline"),document.querySelector("#contact .grid")].filter(Boolean),r=new IntersectionObserver(t=>{t.forEach(o=>{if(o.isIntersecting){const n=o.target;n.querySelectorAll(".fade-up-item").forEach((c,i)=>{setTimeout(()=>{c.classList.add("fade-up-active")},i*80)}),r.unobserve(n)}})},{threshold:.1});e.forEach(t=>{Array.from(t.children).forEach(o=>{o.classList.add("fade-up-item")}),r.observe(t)})}function _(){const e=document.querySelector("section.border-y.hairline");if(!e)return;const r=e.querySelector(".flex");r&&(r.classList.remove("animate-[marquee_40s_linear_infinite]"),r.classList.add("marquee-row","marquee-left"),e.classList.add("marquee-container"))}let b=null,w=null,k=null,S=null,T=null,M="light",q=null;function B(e){M=e,b=document.getElementById("bg-canvas"),b||(b=document.createElement("canvas"),b.id="bg-canvas",b.style.position="fixed",b.style.inset="0",b.style.pointerEvents="none",b.style.zIndex="-1",document.body.prepend(b)),w=b.getContext("2d"),A(),window.removeEventListener("resize",A),window.addEventListener("resize",A),window.removeEventListener("mousemove",P),window.addEventListener("mousemove",P),window.removeEventListener("mouseleave",O),window.addEventListener("mouseleave",O),k&&cancelAnimationFrame(k),M==="dark"&&!q&&Q(),M==="light"?K():J()}function A(){b&&(b.width=window.innerWidth,b.height=window.innerHeight)}function P(e){S=e.clientX,T=e.clientY}function O(){S=null,T=null}function Q(){const e=document.createElement("canvas");e.width=128,e.height=128;const r=e.getContext("2d"),t=r.createImageData(128,128),o=t.data;for(let n=0;n<o.length;n+=4){const a=Math.floor(Math.random()*255);o[n]=a,o[n+1]=a,o[n+2]=a,o[n+3]=6}r.putImageData(t,0,0),q=w.createPattern(e,"repeat")}let F=[];function K(){F=[];const e=60;for(let t=0;t<e;t++)F.push({x:Math.random()*b.width,y:Math.random()*b.height,origX:0,origY:0,vx:(Math.random()>.5?1:-1)*(.15+Math.random()*.15),vy:(Math.random()>.5?1:-1)*(.15+Math.random()*.15),radius:1+Math.random()*1});function r(){w.clearRect(0,0,b.width,b.height),w.fillStyle="rgba(0, 0, 0, 0.04)",F.forEach(t=>{if(t.x+=t.vx,t.y+=t.vy,t.x<0&&(t.x=b.width),t.x>b.width&&(t.x=0),t.y<0&&(t.y=b.height),t.y>b.height&&(t.y=0),S!==null&&T!==null){const o=S-t.x,n=T-t.y;Math.sqrt(o*o+n*n)<80&&(t.x+=o*.02,t.y+=n*.02)}w.beginPath(),w.arc(t.x,t.y,t.radius,0,Math.PI*2),w.fill()}),k=requestAnimationFrame(r)}r()}function J(){let e=performance.now();function r(o){const n=(o-e)/1e3;w.clearRect(0,0,b.width,b.height);const a=b.width,c=b.height,i=a*.4,l=a*(.5+.3*Math.sin(2*Math.PI*n/18)),s=c*(.5+.2*Math.cos(2*Math.PI*n/18));t(l,s,i,"rgba(99, 60, 180, 0.12)");const f=a*.35,d=a*(.5-.25*Math.sin(2*Math.PI*n/24)),u=c*(.5-.2*Math.cos(2*Math.PI*n/24));t(d,u,f,"rgba(30, 80, 160, 0.10)");const p=a*.3,m=a*(.5+.2*Math.sin(2*Math.PI*n/20+Math.PI/4)),h=c*(.5+.2*Math.sin(2*Math.PI*n/20));t(m,h,p,"rgba(140, 60, 100, 0.08)");const g=1+.1*Math.sin(2*Math.PI*n/30),v=a*.45*g,y=a*.5,E=c*.5;t(y,E,v,"rgba(20, 100, 120, 0.07)"),q&&(w.fillStyle=q,w.fillRect(0,0,a,c)),k=requestAnimationFrame(r)}function t(o,n,a,c){if(a<=0)return;const i=w.createRadialGradient(o,n,0,o,n,a);i.addColorStop(0,c),i.addColorStop(1,"rgba(0, 0, 0, 0)"),w.fillStyle=i,w.beginPath(),w.arc(o,n,a,0,Math.PI*2),w.fill()}requestAnimationFrame(r)}document.addEventListener("DOMContentLoaded",()=>{Z(),ee(),te(),ne(),oe(),re(),ae(),ce(),le(),me(),ue(),ie(),se(),de(),pe()});window.addEventListener("click",()=>!0,{once:!0});window.addEventListener("keydown",()=>!0,{once:!0});window.addEventListener("scroll",()=>!0,{once:!0});window.addEventListener("touchstart",()=>!0,{once:!0});function Z(){const e=document.querySelectorAll("#theme-toggle"),r=document.querySelectorAll("#theme-sun-icon"),t=document.querySelectorAll("#theme-moon-icon");if(e.length===0)return;function o(c){c==="dark"?(r.forEach(i=>i.classList.remove("hidden")),t.forEach(i=>i.classList.add("hidden"))):(r.forEach(i=>i.classList.add("hidden")),t.forEach(i=>i.classList.remove("hidden")))}let n=document.documentElement.getAttribute("data-theme");n||(n=localStorage.getItem("ncs-theme")||(window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light")),document.documentElement.setAttribute("data-theme",n),document.documentElement.classList.remove("dark","light"),document.documentElement.classList.add(n),o(n),B(n),setTimeout(()=>{document.documentElement.classList.remove("no-transition")},100);function a(c){const i=document.getElementById("bg-canvas");if(!i){B(c);return}i.style.transition="opacity 300ms ease",i.style.opacity="0",setTimeout(()=>{B(c),i.style.transition="opacity 400ms ease",i.style.opacity="1"},300)}e.forEach(c=>{c.addEventListener("click",()=>{document.documentElement.classList.add("theme-transitioning");const l=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";document.documentElement.setAttribute("data-theme",l),document.documentElement.classList.remove("dark","light"),document.documentElement.classList.add(l),localStorage.setItem("ncs-theme",l),o(l),a(l),setTimeout(()=>{document.documentElement.classList.remove("theme-transitioning")},600)})})}function ee(){const e=document.querySelectorAll(".faq-item");e.forEach(r=>{const t=r.querySelector(".faq-trigger");t&&t.addEventListener("click",()=>{const o=r.classList.contains("active");e.forEach(n=>{n.classList.remove("active")}),o||r.classList.add("active")})})}function te(){const e=document.getElementById("roi-hours"),r=document.getElementById("roi-cost"),t=document.getElementById("roi-team"),o=document.getElementById("roi-hours-label"),n=document.getElementById("roi-cost-label"),a=document.getElementById("roi-team-label"),c=document.getElementById("roi-drain-value"),i=document.getElementById("roi-recoverable-value");if(!e||!r||!t)return;function l(d){return"$"+Math.round(d).toLocaleString()}function s(d){const u=parseFloat(d.min)||0,p=parseFloat(d.max)||100,h=((parseFloat(d.value)||0)-u)/(p-u)*100;d.style.setProperty("--percent",h+"%")}function f(){const d=parseInt(e.value,10),u=parseInt(r.value,10),p=parseInt(t.value,10);o&&(o.textContent=d+" hrs"),n&&(n.textContent="$"+u+" / hr"),a&&(a.textContent=p+(p===1?" person":" people")),s(e),s(r),s(t);const m=d*u*p*52,h=m*.78;c&&(c.innerHTML=`${l(m)}<span class="text-sm font-normal text-muted-foreground tracking-normal"> / year</span>`),i&&(i.innerHTML=`${l(h)}<span class="text-sm font-normal text-muted-foreground tracking-normal"> / year</span>`)}[e,r,t].forEach(d=>{d.addEventListener("input",f)}),f()}function ne(){const e=document.getElementById("testimonial-slider");if(!e)return;const r=e.querySelectorAll(".testimonial-slide"),t=document.getElementById("testimonial-prev"),o=document.getElementById("testimonial-next"),n=document.querySelectorAll("#testimonial-dots button");if(r.length===0)return;let a=0,c=!1;function i(l){if(c||l===a)return;c=!0;const s=r[a],f=r[l];s.style.opacity="0",n[a].classList.remove("bg-primary","w-4"),n[a].classList.add("bg-foreground/25","w-2"),setTimeout(()=>{s.classList.add("hidden"),f.classList.remove("hidden"),f.offsetHeight,f.style.opacity="1",n[l].classList.remove("bg-foreground/25","w-2"),n[l].classList.add("bg-primary","w-4"),a=l,c=!1},300)}t==null||t.addEventListener("click",()=>{let l=a-1;l<0&&(l=r.length-1),i(l)}),o==null||o.addEventListener("click",()=>{let l=a+1;l>=r.length&&(l=0),i(l)}),n.forEach((l,s)=>{l.addEventListener("click",()=>{i(s)})}),r.forEach((l,s)=>{l.style.transition="opacity 0.3s ease",s!==0?l.style.opacity="0":l.style.opacity="1"})}function oe(){const e=document.querySelectorAll("section[id]"),r=document.querySelectorAll(".nav-link"),t=document.getElementById("active-section-indicator");if(e.length===0)return;const o={hero:"Home",problem:"Pain Points","what-i-build":"Services",toolkit:"Toolkit",services:"Pricing",process:"Process",work:"Selected Work","work-list":"Archive",about:"About",faq:"FAQ",contact:"Contact"},n={root:null,rootMargin:"-20% 0px -60% 0px",threshold:0},a=new IntersectionObserver(c=>{c.forEach(i=>{if(i.isIntersecting){const l=i.target.getAttribute("id");if(t){const s=o[l]||l.charAt(0).toUpperCase()+l.slice(1);t.innerHTML=`Viewing ${s} <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-up-right h-3 w-3"><path d="M7 7h10v10"></path><path d="M7 17 17 7"></path></svg>`}r.forEach(s=>{const f=s.getAttribute("href");f===`#${l}`||l==="work-list"&&f==="#work"||l==="what-i-build"&&f==="#services"?(s.classList.add("bg-primary","text-primary-foreground","active"),s.classList.remove("text-foreground/80")):(s.classList.remove("bg-primary","text-primary-foreground","active"),s.classList.add("text-foreground/80"))})}})},n);e.forEach(c=>a.observe(c))}function re(){const e=document.getElementById("chatbot-toggle"),r=document.getElementById("chatbot-close"),t=document.getElementById("chatbot-window"),o=document.getElementById("chat-messages"),n=document.getElementById("chat-input"),a=document.getElementById("chat-form"),c=document.getElementById("chat-loading"),i=a==null?void 0:a.querySelector("button[type='submit']"),l=document.querySelectorAll(".chat-pill");if(!e||!t)return;const s=[{topic:"Full-Stack + Bubble",answer:"I architect the data model first, then ship UI in Bubble for visual surfaces and Next.js for anything that demands custom code."},{topic:"UI/UX Design",answer:"Design is structural — I work in Figma, then prototype directly in code. Token-first, component-driven."},{topic:"Custom Dev",answer:"Next.js + Supabase, TypeScript everywhere, edge-deployed. I write the code I'd want to inherit."}];d("assistant","Hey <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='lucide lucide-hand inline-block mr-1 align-text-bottom text-primary'><path d='M18 11V6a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v5'></path><path d='M14 10V4a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v8'></path><path d='M10 10.5V6a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v8'></path><path d='M6 15a4 4 0 0 0-4-4v0a2 2 0 0 0-2 2v6a8 8 0 0 0 8 8h5a6 6 0 0 0 6-6v-3a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2'></path></svg> I'm the Emmanuel Twin. Ask me about how I build, what I charge, or anything else. Pick a starter or type a question."),e.addEventListener("click",()=>{t.classList.remove("hidden"),e.classList.add("opacity-0","pointer-events-none"),p()}),r.addEventListener("click",()=>{t.classList.add("hidden"),e.classList.remove("opacity-0","pointer-events-none")}),n.addEventListener("input",()=>{const m=n.value.trim().length>0;i.disabled=!m}),a.addEventListener("submit",m=>{m.preventDefault();const h=n.value.trim();h&&u(h)}),l.forEach(m=>{m.addEventListener("click",()=>{u(m.textContent)})});function d(m,h){const g=document.createElement("div");g.className=m==="user"?"flex justify-end":"flex justify-start";const v=m==="user",y=v?"bg-primary text-primary-foreground":"bg-foreground/[0.04] text-foreground border hairline",E=v?"rounded-2xl rounded-tr-none":"rounded-2xl rounded-tl-none";g.innerHTML=`
    ...
    `,document.head.appendChild(u)}function l(){c||i||n&&!n.classList.contains("hidden")||(c=!0,e.style.animation="none",e.classList.remove("hidden"),e.offsetHeight,e.style.animation="popupIn 0.5s cubic-bezier(0.22,1,0.36,1) both",o.classList.add("pulse-hint"),setTimeout(()=>{i||s()},1e4))}function s(u=!1){if(!e.classList.contains("hidden")){if(o.classList.remove("pulse-hint"),u){e.classList.add("hidden");return}e.style.animation="popupOut 0.3s ease forwards",setTimeout(()=>e.classList.add("hidden"),290)}}function f(){i=!0,s(!0),n&&(n.classList.remove("hidden"),o.classList.add("opacity-0","pointer-events-none"))}const d=document.getElementById("what-i-build");if(d){const u=new IntersectionObserver(p=>{p.forEach(m=>{m.isIntersecting&&!c&&!i&&(l(),u.unobserve(m.target))})},{rootMargin:"0px 0px -25% 0px"});u.observe(d)}else{const u=()=>{if(c||i){window.removeEventListener("scroll",u);return}window.scrollY>400&&(l(),window.removeEventListener("scroll",u))};window.addEventListener("scroll",u,{passive:!0})}r&&r.addEventListener("click",u=>{u.stopPropagation(),i=!0,s()}),t&&t.addEventListener("click",u=>{u.stopPropagation(),f(),setTimeout(()=>{const p=document.getElementById("chat-input");p&&p.focus()},150)}),o.addEventListener("click",()=>{i=!0,s(!0)}),a&&a.addEventListener("click",()=>{o.classList.remove("pulse-hint")})}function se(){const e=document.getElementById("back-to-top");if(!e)return;let r=!1;window.addEventListener("scroll",()=>{const t=window.scrollY>400;t!==r&&(r=t,r?(e.classList.remove("opacity-0","pointer-events-none","translate-y-4"),e.classList.add("opacity-100","pointer-events-auto","translate-y-0")):(e.classList.add("opacity-0","pointer-events-none","translate-y-4"),e.classList.remove("opacity-100","pointer-events-auto","translate-y-0")))},{passive:!0}),e.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})})}function ce(){const e=document.querySelector(".stats-grid");if(!e)return;const r=e.querySelectorAll("dt"),t=[];r.forEach(i=>{const s=i.textContent.trim().match(/^([^0-9]*)([0-9]+)([^0-9]*)$/);if(s){const f=s[1],d=parseInt(s[2],10),u=s[3];t.push({el:i,prefix:f,targetVal:d,suffix:u}),i.textContent=`${f}0${u}`}});function o(i){return i===1?1:1-Math.pow(2,-10*i)}function n(i,l,s,f,d,u){const p=performance.now();function m(h){const g=h-p,v=Math.min(g/u,1),y=o(v),E=Math.floor(l+(s-l)*y);i.textContent=`${f}${E}${d}`,v<1?requestAnimationFrame(m):i.textContent=`${f}${s}${d}`}requestAnimationFrame(m)}const a={root:null,threshold:.1,rootMargin:"0px 0px -50px 0px"},c=new IntersectionObserver(i=>{i.forEach(l=>{l.isIntersecting&&(t.forEach(s=>{n(s.el,0,s.targetVal,s.prefix,s.suffix,2e3)}),c.unobserve(l.target))})},a);c.observe(e)}function le(){const e=document.getElementById("hero-loop-video");if(!e)return;const r={root:null,threshold:.1};new IntersectionObserver(o=>{o.forEach(n=>{n.isIntersecting?e.play().catch(()=>{}):e.pause()})},r).observe(e)}function de(){const e=document.getElementById("enhanced-contact-form");if(!e)return;const r=document.getElementById("contact-submit-btn"),t=document.getElementById("contact-btn-text"),o=document.getElementById("contact-btn-icon"),n=document.getElementById("contact-success"),a=document.getElementById("contact-error");e.addEventListener("submit",async c=>{c.preventDefault(),r&&(r.disabled=!0),t&&(t.textContent="Sending..."),o&&o.classList.add("animate-pulse"),n&&n.classList.add("hidden"),a&&a.classList.add("hidden");try{const i=new FormData(e);(await fetch(e.action,{method:"POST",body:i,headers:{Accept:"application/json"}})).ok?(e.reset(),n&&n.classList.remove("hidden"),t&&(t.textContent="Sent!")):(a&&a.classList.remove("hidden"),t&&(t.textContent="Send message"),r&&(r.disabled=!1))}catch{a&&a.classList.remove("hidden"),t&&(t.textContent="Send message"),r&&(r.disabled=!1)}finally{o&&o.classList.remove("animate-pulse")}})}function ue(){const e=document.getElementById("hero-loop-video"),r=document.getElementById("video-sound-toggle"),t=document.getElementById("video-sound-off"),o=document.getElementById("video-sound-on");!e||!r||r.addEventListener("click",n=>{n.stopPropagation();const a=e.muted;e.muted=!a,e.muted?(t.classList.remove("hidden"),o.classList.add("hidden")):(t.classList.add("hidden"),o.classList.remove("hidden"))})}function me(){const e=document.getElementById("hero-loop-video"),r=document.getElementById("video-play-toggle"),t=document.getElementById("video-pause-icon"),o=document.getElementById("video-play-icon");!e||!r||(r.addEventListener("click",n=>{n.stopPropagation(),e.paused?e.play().then(()=>{t.classList.remove("hidden"),o.classList.add("hidden")}).catch(a=>{console.error("Video play failed:",a)}):(e.pause(),t.classList.add("hidden"),o.classList.remove("hidden"))}),e.addEventListener("play",()=>{t.classList.remove("hidden"),o.classList.add("hidden")}),e.addEventListener("pause",()=>{t.classList.add("hidden"),o.classList.remove("hidden")}))}function pe(){const e=document.getElementById("about-portrait-wrapper");e&&e.addEventListener("click",()=>{e.classList.toggle("touch-active")})}
