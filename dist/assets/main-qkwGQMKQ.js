document.addEventListener("DOMContentLoaded",()=>{const e=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(P(),e){H();return}R(),Y(),j(),X(),z(),_(),V(),U(),W(),J(),G(),Q()});function P(){const e=document.createElement("style");e.textContent=`
  ...
  `,document.head.appendChild(e)}function H(){document.querySelectorAll("#hero dl dt").forEach(t=>{t.style.transform="none"});const o=document.querySelector("#about");if(o){o.querySelectorAll(".char-rollup-target").forEach(i=>i.style.transform="none"),o.querySelectorAll(".space-y-6 > p").forEach(i=>{i.style.filter="none",i.style.opacity="1",i.style.transform="none"}),o.querySelectorAll(".flex.flex-wrap.gap-2.text-xs span").forEach(i=>{i.style.opacity="1",i.style.transform="none"});const a=document.getElementById("about-portrait");a&&(a.style.opacity="1",a.style.transform="none");const d=document.getElementById("about-tagline-container");d&&(d.style.opacity="1",d.style.transform="none")}}function R(){const e=document.querySelector("#hero h1");if(!e)return;e.classList.add("clip-reveal");let o=0;const t=.06;function n(r){if(r.nodeType===Node.TEXT_NODE){const d=r.nodeValue.split(/(\s+)/),i=document.createDocumentFragment();d.forEach(s=>{if(s.trim().length>0){const c=document.createElement("span");c.className="animate-word",c.textContent=s,c.style.animationDelay=`${o*t}s`,i.appendChild(c),o++}else i.appendChild(document.createTextNode(s))}),r.parentNode.replaceChild(i,r)}else r.nodeType===Node.ELEMENT_NODE&&r.tagName!=="SVG"&&Array.from(r.childNodes).forEach(n)}Array.from(e.childNodes).forEach(n)}function Y(){const e=document.querySelector('header a[href="#hero"]');if(!e)return;const o=e.querySelector(".bg-primary"),t=e.querySelector(".text-primary");if(!t||!o)return;const n="Nocode",r="Savvy";let a=!1;e.addEventListener("mouseenter",()=>{if(a)return;a=!0;const d="ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789",i=performance.now(),s=600,c=30;function p(l){const u=l-i;let f="";for(let g=0;g<n.length;g++){const v=g*c;u>=s||u>=v+(s-n.length*c)?f+=n[g]:f+=d[Math.floor(Math.random()*d.length)]}let m="";for(let g=0;g<r.length;g++){const v=(n.length+g)*c;u>=s||u>=v+(s-(n.length+r.length)*c)?m+=r[g]:m+=d[Math.floor(Math.random()*d.length)]}let h=o.nextSibling;h&&h.nodeType===Node.TEXT_NODE&&(h.nodeValue=f),t.textContent=m,u<s?requestAnimationFrame(p):(h&&h.nodeType===Node.TEXT_NODE&&(h.nodeValue=n),t.textContent=r,a=!1)}requestAnimationFrame(p)})}function j(){const e=document.querySelectorAll("h1, h2, h3"),o=[];e.forEach(n=>{const r=n.textContent.trim();r.split(/\s+/).length<=3&&(n.classList.add("gradient-wipe"),n.setAttribute("data-text",r),o.push(n))});const t=new IntersectionObserver(n=>{n.forEach(r=>{r.isIntersecting&&(r.target.classList.add("wipe-active"),t.unobserve(r.target))})},{threshold:.5});o.forEach(n=>t.observe(n))}function X(){const e=document.getElementById("typewriter-text");if(!e)return;const o=["SaaS platforms that scale.","Bubble apps that don't break.","AI integrations that actually work.","Payment systems wired right.","MVPs shipped in 3 weeks.","The thing your business actually needs."];let t=0,n=0,r=!1;setTimeout(()=>{a()},1400);function a(){const d=o[t];r?(e.textContent=d.substring(0,n-1),n--,n===0?(r=!1,t=(t+1)%o.length,setTimeout(a,550)):setTimeout(a,30)):(e.textContent=d.substring(0,n+1),n++,n===d.length?(r=!0,setTimeout(a,1600)):setTimeout(a,55))}}function z(){const e=document.querySelectorAll(".underline-sweep-target");if(e.length===0)return;const o=new IntersectionObserver(t=>{t.forEach(n=>{n.isIntersecting&&(n.target.classList.add("sweep-active"),o.unobserve(n.target))})},{threshold:.3});e.forEach(t=>o.observe(t))}function _(){const e=document.querySelector("#about");if(!e)return;const o=e.querySelectorAll(".char-rollup-target"),t=[],n="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!@#$%^&*()_+";o.forEach(c=>{const p=c.textContent.trim();c.innerHTML="",c.classList.add("char-roll-container");const l=[];for(let u=0;u<p.length;u++){const f=p[u];if(f===" "){const m=document.createElement("span");m.className="char-roll-char",m.innerHTML="&nbsp;",c.appendChild(m)}else{const m=document.createElement("span");m.className="char-roll-col";const h=10;for(let v=0;v<h;v++){const y=document.createElement("span");y.className="char-roll-char",y.textContent=n[Math.floor(Math.random()*n.length)],m.appendChild(y)}const g=document.createElement("span");g.className="char-roll-char",g.textContent=f,m.appendChild(g),c.appendChild(m),l.push({col:m,index:u})}}t.push({columns:l,target:c})});const r=e.querySelectorAll(".space-y-6 > p");r.forEach(c=>c.classList.add("about-bio-p"));const a=e.querySelectorAll(".flex.flex-wrap.gap-2.text-xs span");a.forEach(c=>c.classList.add("about-badge-item"));const d=document.getElementById("about-portrait"),i=new IntersectionObserver(c=>{c.forEach(p=>{if(p.isIntersecting){if(t.forEach(({columns:l})=>{l.forEach(({col:u,index:f})=>{setTimeout(()=>{u.style.transform=`translateY(-${10*1.2}em)`},f*35)})}),r.forEach((l,u)=>{setTimeout(()=>{l.classList.add("reveal-active")},u*180)}),a.forEach((l,u)=>{setTimeout(()=>{l.classList.add("reveal-active")},u*120)}),d){d.classList.add("reveal-active");const l=document.getElementById("about-tagline-container");l&&l.classList.add("reveal-active"),setTimeout(()=>{d.classList.add("portrait-pulse-active")},900)}i.unobserve(p.target)}})},{threshold:.15});i.observe(e),e.querySelectorAll(".about-magnetic-card").forEach(c=>{c.addEventListener("mousemove",p=>{const l=c.getBoundingClientRect(),u=l.left+l.width/2,f=l.top+l.height/2,m=p.clientX,h=p.clientY,g=m-u,v=h-f,y=g/l.width*16,x=v/l.height*16,L=Math.sqrt(y*y+x*x),E=8;let I=y,k=x;L>E&&(I=y/L*E,k=x/L*E),c.style.transition="none",c.style.transform=`translate(${I}px, ${k}px)`}),c.addEventListener("mouseleave",()=>{c.style.transition="transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",c.style.transform="translate(0px, 0px)"})})}function V(){const e=document.querySelectorAll("#work .grid a");if(e.length===0)return;e.forEach(t=>{t.classList.add("curtain-card");const n=document.createElement("div");n.className="curtain-overlay",t.appendChild(n)});const o=new IntersectionObserver(t=>{let n=0;t.forEach(r=>{if(r.isIntersecting){const a=r.target;setTimeout(()=>{a.classList.add("wipe-active")},n*120),n++,o.unobserve(a)}})},{threshold:.2});e.forEach(t=>o.observe(t))}function U(){const e=document.querySelectorAll("#problem .grid > div"),o=document.querySelectorAll("#what-i-build .grid > div");[...e,...o].forEach(n=>{n.classList.add("draw-border-card");const r=document.createElement("span");r.className="draw-border-line draw-border-top";const a=document.createElement("span");a.className="draw-border-line draw-border-right";const d=document.createElement("span");d.className="draw-border-line draw-border-bottom";const i=document.createElement("span");i.className="draw-border-line draw-border-left",n.appendChild(r),n.appendChild(a),n.appendChild(d),n.appendChild(i)})}function W(){const e=document.querySelector(".font-display.text-5xl"),o=document.querySelector(".font-display.text-3xl.text-primary"),t=document.querySelectorAll("input[type='range']");if(!e||!o||t.length<3)return;let n=0,r=0,a=!0;function d(l){return"$"+Math.round(l).toLocaleString()}function i(){const l=parseInt(t[0].value,10),u=parseInt(t[1].value,10),f=parseInt(t[2].value,10),m=l*u*f*52,h=m*.78;return{drain:m,recoverable:h}}function s(l=400){const{drain:u,recoverable:f}=i();c(e,n,u,l,d,' <span class="text-base text-muted-foreground">/ year</span>'),c(o,r,f,l,d,' <span class="text-base text-muted-foreground">/ year</span>'),n=u,r=f}function c(l,u,f,m,h,g){const v=performance.now();function y(x){const L=x-v,E=Math.min(L/m,1),I=E===1?1:1-Math.pow(2,-10*E),k=u+(f-u)*I;l.innerHTML=`${h(k)}${g}`,E<1?requestAnimationFrame(y):l.innerHTML=`${h(f)}${g}`}requestAnimationFrame(y)}t.forEach(l=>{l.addEventListener("input",()=>{s(400)})});const p=document.querySelector("#roi-calc")||document.querySelector("section[data-section='services'] + section");if(p){const l=new IntersectionObserver(u=>{u.forEach(f=>{if(f.isIntersecting&&a){a=!1;const{drain:m,recoverable:h}=i();n=m,r=h,c(e,0,m,1200,d,' <span class="text-base text-muted-foreground">/ year</span>'),c(o,0,h,1200,d,' <span class="text-base text-muted-foreground">/ year</span>'),l.unobserve(f.target)}})},{threshold:.1});l.observe(p)}}function J(){document.querySelectorAll(".faq-answer").forEach(o=>{const t=document.createElement("div");t.className="faq-answer-inner",t.innerHTML=o.innerHTML,o.innerHTML="",o.appendChild(t)})}function G(){const e=[document.querySelector("#toolkit .grid"),document.querySelector("#services .space-y-4"),document.querySelector("#process .rounded-2xl"),document.querySelector("#work-list tbody"),document.querySelector("#faq .space-y-4")||document.querySelector("#faq .border-t.hairline"),document.querySelector("#contact .grid")].filter(Boolean),o=new IntersectionObserver(t=>{t.forEach(n=>{if(n.isIntersecting){const r=n.target;r.querySelectorAll(".fade-up-item").forEach((d,i)=>{setTimeout(()=>{d.classList.add("fade-up-active")},i*80)}),o.unobserve(r)}})},{threshold:.1});e.forEach(t=>{Array.from(t.children).forEach(n=>{n.classList.add("fade-up-item")}),o.observe(t)})}function Q(){const e=document.querySelector("section.border-y.hairline");if(!e)return;const o=e.querySelector(".flex");o&&(o.classList.remove("animate-[marquee_40s_linear_infinite]"),o.classList.add("marquee-row","marquee-left"),e.classList.add("marquee-container"))}let b=null,w=null,S=null,T=null,M=null,A="light",q=null;function $(e){A=e,b=document.getElementById("bg-canvas"),b||(b=document.createElement("canvas"),b.id="bg-canvas",b.style.position="fixed",b.style.inset="0",b.style.pointerEvents="none",b.style.zIndex="-1",document.body.prepend(b)),w=b.getContext("2d"),F(),window.removeEventListener("resize",F),window.addEventListener("resize",F),window.removeEventListener("mousemove",D),window.addEventListener("mousemove",D),window.removeEventListener("mouseleave",O),window.addEventListener("mouseleave",O),S&&cancelAnimationFrame(S),A==="dark"&&!q&&Z(),A==="light"?K():ee()}function F(){b&&(b.width=window.innerWidth,b.height=window.innerHeight)}function D(e){T=e.clientX,M=e.clientY}function O(){T=null,M=null}function Z(){const e=document.createElement("canvas");e.width=128,e.height=128;const o=e.getContext("2d"),t=o.createImageData(128,128),n=t.data;for(let r=0;r<n.length;r+=4){const a=Math.floor(Math.random()*255);n[r]=a,n[r+1]=a,n[r+2]=a,n[r+3]=6}o.putImageData(t,0,0),q=w.createPattern(e,"repeat")}let N=[];function K(){N=[];const e=60;for(let t=0;t<e;t++)N.push({x:Math.random()*b.width,y:Math.random()*b.height,origX:0,origY:0,vx:(Math.random()>.5?1:-1)*(.15+Math.random()*.15),vy:(Math.random()>.5?1:-1)*(.15+Math.random()*.15),radius:1+Math.random()*1});function o(){w.clearRect(0,0,b.width,b.height),w.fillStyle="rgba(0, 0, 0, 0.04)",N.forEach(t=>{if(t.x+=t.vx,t.y+=t.vy,t.x<0&&(t.x=b.width),t.x>b.width&&(t.x=0),t.y<0&&(t.y=b.height),t.y>b.height&&(t.y=0),T!==null&&M!==null){const n=T-t.x,r=M-t.y;Math.sqrt(n*n+r*r)<80&&(t.x+=n*.02,t.y+=r*.02)}w.beginPath(),w.arc(t.x,t.y,t.radius,0,Math.PI*2),w.fill()}),S=requestAnimationFrame(o)}o()}function ee(){let e=performance.now();function o(n){const r=(n-e)/1e3;w.clearRect(0,0,b.width,b.height);const a=b.width,d=b.height,i=a*.4,s=a*(.5+.3*Math.sin(2*Math.PI*r/18)),c=d*(.5+.2*Math.cos(2*Math.PI*r/18));t(s,c,i,"rgba(99, 60, 180, 0.12)");const p=a*.35,l=a*(.5-.25*Math.sin(2*Math.PI*r/24)),u=d*(.5-.2*Math.cos(2*Math.PI*r/24));t(l,u,p,"rgba(30, 80, 160, 0.10)");const f=a*.3,m=a*(.5+.2*Math.sin(2*Math.PI*r/20+Math.PI/4)),h=d*(.5+.2*Math.sin(2*Math.PI*r/20));t(m,h,f,"rgba(140, 60, 100, 0.08)");const g=1+.1*Math.sin(2*Math.PI*r/30),v=a*.45*g,y=a*.5,x=d*.5;t(y,x,v,"rgba(20, 100, 120, 0.07)"),q&&(w.fillStyle=q,w.fillRect(0,0,a,d)),S=requestAnimationFrame(o)}function t(n,r,a,d){if(a<=0)return;const i=w.createRadialGradient(n,r,0,n,r,a);i.addColorStop(0,d),i.addColorStop(1,"rgba(0, 0, 0, 0)"),w.fillStyle=i,w.beginPath(),w.arc(n,r,a,0,Math.PI*2),w.fill()}requestAnimationFrame(o)}document.addEventListener("DOMContentLoaded",async()=>{te(),ne(),oe();try{await we()}catch(e){console.error("Dynamic content hydration failed:",e)}re(),ae(),ie(),se(),de(),ue(),fe(),pe(),ce(),le(),me(),he(),xe()});window.addEventListener("click",()=>!0,{once:!0});window.addEventListener("keydown",()=>!0,{once:!0});window.addEventListener("scroll",()=>!0,{once:!0});window.addEventListener("touchstart",()=>!0,{once:!0});function te(){const e=document.querySelectorAll("#theme-toggle"),o=document.querySelectorAll("#theme-sun-icon"),t=document.querySelectorAll("#theme-moon-icon");if(e.length===0)return;function n(d){d==="dark"?(o.forEach(i=>i.classList.remove("hidden")),t.forEach(i=>i.classList.add("hidden"))):(o.forEach(i=>i.classList.add("hidden")),t.forEach(i=>i.classList.remove("hidden")))}let r=document.documentElement.getAttribute("data-theme");r||(r=localStorage.getItem("ncs-theme")||(window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light")),document.documentElement.setAttribute("data-theme",r),document.documentElement.classList.remove("dark","light"),document.documentElement.classList.add(r),n(r),$(r),setTimeout(()=>{document.documentElement.classList.remove("no-transition")},100);function a(d){const i=document.getElementById("bg-canvas");if(!i){$(d);return}i.style.transition="opacity 300ms ease",i.style.opacity="0",setTimeout(()=>{$(d),i.style.transition="opacity 400ms ease",i.style.opacity="1"},300)}e.forEach(d=>{d.addEventListener("click",()=>{document.documentElement.classList.add("theme-transitioning");const s=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";document.documentElement.setAttribute("data-theme",s),document.documentElement.classList.remove("dark","light"),document.documentElement.classList.add(s),localStorage.setItem("ncs-theme",s),n(s),a(s),setTimeout(()=>{document.documentElement.classList.remove("theme-transitioning")},600)})})}function ne(){const e=document.querySelectorAll(".faq-item");e.forEach(o=>{const t=o.querySelector(".faq-trigger");t&&t.addEventListener("click",()=>{const n=o.classList.contains("active");e.forEach(r=>{r.classList.remove("active")}),n||o.classList.add("active")})})}function oe(){const e=document.getElementById("roi-hours"),o=document.getElementById("roi-cost"),t=document.getElementById("roi-team"),n=document.getElementById("roi-hours-label"),r=document.getElementById("roi-cost-label"),a=document.getElementById("roi-team-label"),d=document.getElementById("roi-drain-value"),i=document.getElementById("roi-recoverable-value");if(!e||!o||!t)return;function s(l){return"$"+Math.round(l).toLocaleString()}function c(l){const u=parseFloat(l.min)||0,f=parseFloat(l.max)||100,h=((parseFloat(l.value)||0)-u)/(f-u)*100;l.style.setProperty("--percent",h+"%")}function p(){const l=parseInt(e.value,10),u=parseInt(o.value,10),f=parseInt(t.value,10);n&&(n.textContent=l+" hrs"),r&&(r.textContent="$"+u+" / hr"),a&&(a.textContent=f+(f===1?" person":" people")),c(e),c(o),c(t);const m=l*u*f*52,h=m*.78;d&&(d.innerHTML=`${s(m)}<span class="text-sm font-normal text-muted-foreground tracking-normal"> / year</span>`),i&&(i.innerHTML=`${s(h)}<span class="text-sm font-normal text-muted-foreground tracking-normal"> / year</span>`)}[e,o,t].forEach(l=>{l.addEventListener("input",p)}),p()}function re(){const e=document.getElementById("testimonial-slider");if(!e)return;const o=e.querySelectorAll(".testimonial-slide"),t=document.getElementById("testimonial-prev"),n=document.getElementById("testimonial-next"),r=document.querySelectorAll("#testimonial-dots button");if(o.length===0)return;let a=0,d=!1;function i(s){if(d||s===a)return;d=!0;const c=o[a],p=o[s];c.style.opacity="0",r[a].classList.remove("bg-primary","w-4"),r[a].classList.add("bg-foreground/25","w-2"),setTimeout(()=>{c.classList.add("hidden"),p.classList.remove("hidden"),p.offsetHeight,p.style.opacity="1",r[s].classList.remove("bg-foreground/25","w-2"),r[s].classList.add("bg-primary","w-4"),a=s,d=!1},300)}t==null||t.addEventListener("click",()=>{let s=a-1;s<0&&(s=o.length-1),i(s)}),n==null||n.addEventListener("click",()=>{let s=a+1;s>=o.length&&(s=0),i(s)}),r.forEach((s,c)=>{s.addEventListener("click",()=>{i(c)})}),o.forEach((s,c)=>{s.style.transition="opacity 0.3s ease",c!==0?s.style.opacity="0":s.style.opacity="1"})}function ae(){const e=document.querySelectorAll("section[id]"),o=document.querySelectorAll(".nav-link"),t=document.getElementById("active-section-indicator");if(e.length===0)return;const n={hero:"Home",problem:"Pain Points","what-i-build":"Services",toolkit:"Toolkit",services:"Pricing",process:"Process",work:"Selected Work","work-list":"Archive",about:"About",faq:"FAQ",contact:"Contact"},r={root:null,rootMargin:"-20% 0px -60% 0px",threshold:0},a=new IntersectionObserver(d=>{d.forEach(i=>{if(i.isIntersecting){const s=i.target.getAttribute("id");if(t){const c=n[s]||s.charAt(0).toUpperCase()+s.slice(1);t.innerHTML=`Viewing ${c} <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-up-right h-3 w-3"><path d="M7 7h10v10"></path><path d="M7 17 17 7"></path></svg>`}o.forEach(c=>{const p=c.getAttribute("href");p===`#${s}`||s==="work-list"&&p==="#work"||s==="what-i-build"&&p==="#services"?(c.classList.add("bg-primary","text-primary-foreground","active"),c.classList.remove("text-foreground/80")):(c.classList.remove("bg-primary","text-primary-foreground","active"),c.classList.add("text-foreground/80"))})}})},r);e.forEach(d=>a.observe(d))}function ie(){const e=document.getElementById("chatbot-toggle"),o=document.getElementById("chatbot-close"),t=document.getElementById("chatbot-window"),n=document.getElementById("chat-messages"),r=document.getElementById("chat-input"),a=document.getElementById("chat-form"),d=document.getElementById("chat-loading"),i=a==null?void 0:a.querySelector("button[type='submit']"),s=document.querySelectorAll(".chat-pill");if(!e||!t)return;const c=[{topic:"Full-Stack + Bubble",answer:"I architect the data model first, then ship UI in Bubble for visual surfaces and Next.js for anything that demands custom code."},{topic:"UI/UX Design",answer:"Design is structural — I work in Figma, then prototype directly in code. Token-first, component-driven."},{topic:"Custom Dev",answer:"Next.js + Supabase, TypeScript everywhere, edge-deployed. I write the code I'd want to inherit."}];l("assistant","Hey <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='lucide lucide-hand inline-block mr-1 align-text-bottom text-primary'><path d='M18 11V6a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v5'></path><path d='M14 10V4a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v8'></path><path d='M10 10.5V6a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v8'></path><path d='M6 15a4 4 0 0 0-4-4v0a2 2 0 0 0-2 2v6a8 8 0 0 0 8 8h5a6 6 0 0 0 6-6v-3a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2'></path></svg> I'm the Emmanuel Twin. Ask me about how I build, what I charge, or anything else. Pick a starter or type a question."),e.addEventListener("click",()=>{t.classList.remove("hidden"),e.classList.add("opacity-0","pointer-events-none"),f()}),o.addEventListener("click",()=>{t.classList.add("hidden"),e.classList.remove("opacity-0","pointer-events-none")}),r.addEventListener("input",()=>{const m=r.value.trim().length>0;i.disabled=!m}),a.addEventListener("submit",m=>{m.preventDefault();const h=r.value.trim();h&&u(h)}),s.forEach(m=>{m.addEventListener("click",()=>{u(m.textContent)})});function l(m,h){const g=document.createElement("div");g.className=m==="user"?"flex justify-end":"flex justify-start";const v=m==="user",y=v?"bg-primary text-primary-foreground":"bg-foreground/[0.04] text-foreground border hairline",x=v?"rounded-2xl rounded-tr-none":"rounded-2xl rounded-tl-none";g.innerHTML=`
    ...
    `,document.head.appendChild(u)}function s(){d||i||r&&!r.classList.contains("hidden")||(d=!0,e.style.animation="none",e.classList.remove("hidden"),e.offsetHeight,e.style.animation="popupIn 0.5s cubic-bezier(0.22,1,0.36,1) both",n.classList.add("pulse-hint"),setTimeout(()=>{i||c()},1e4))}function c(u=!1){if(!e.classList.contains("hidden")){if(n.classList.remove("pulse-hint"),u){e.classList.add("hidden");return}e.style.animation="popupOut 0.3s ease forwards",setTimeout(()=>e.classList.add("hidden"),290)}}function p(){i=!0,c(!0),r&&(r.classList.remove("hidden"),n.classList.add("opacity-0","pointer-events-none"))}const l=document.getElementById("what-i-build");if(l){const u=new IntersectionObserver(f=>{f.forEach(m=>{m.isIntersecting&&!d&&!i&&(s(),u.unobserve(m.target))})},{rootMargin:"0px 0px -25% 0px"});u.observe(l)}else{const u=()=>{if(d||i){window.removeEventListener("scroll",u);return}window.scrollY>400&&(s(),window.removeEventListener("scroll",u))};window.addEventListener("scroll",u,{passive:!0})}o&&o.addEventListener("click",u=>{u.stopPropagation(),i=!0,c()}),t&&t.addEventListener("click",u=>{u.stopPropagation(),p(),setTimeout(()=>{const f=document.getElementById("chat-input");f&&f.focus()},150)}),n.addEventListener("click",()=>{i=!0,c(!0)}),a&&a.addEventListener("click",()=>{n.classList.remove("pulse-hint")})}function le(){const e=document.getElementById("back-to-top");if(!e)return;let o=!1;window.addEventListener("scroll",()=>{const t=window.scrollY>400;t!==o&&(o=t,o?(e.classList.remove("opacity-0","pointer-events-none","translate-y-4"),e.classList.add("opacity-100","pointer-events-auto","translate-y-0")):(e.classList.add("opacity-0","pointer-events-none","translate-y-4"),e.classList.remove("opacity-100","pointer-events-auto","translate-y-0")))},{passive:!0}),e.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})})}function de(){const e=document.querySelector(".stats-grid");if(!e)return;const o=e.querySelectorAll("dt"),t=[];o.forEach(i=>{const c=i.textContent.trim().match(/^([^0-9]*)([0-9]+)([^0-9]*)$/);if(c){const p=c[1],l=parseInt(c[2],10),u=c[3];t.push({el:i,prefix:p,targetVal:l,suffix:u}),i.textContent=`${p}0${u}`}});function n(i){return i===1?1:1-Math.pow(2,-10*i)}function r(i,s,c,p,l,u){const f=performance.now();function m(h){const g=h-f,v=Math.min(g/u,1),y=n(v),x=Math.floor(s+(c-s)*y);i.textContent=`${p}${x}${l}`,v<1?requestAnimationFrame(m):i.textContent=`${p}${c}${l}`}requestAnimationFrame(m)}const a={root:null,threshold:.1,rootMargin:"0px 0px -50px 0px"},d=new IntersectionObserver(i=>{i.forEach(s=>{s.isIntersecting&&(t.forEach(c=>{r(c.el,0,c.targetVal,c.prefix,c.suffix,2e3)}),d.unobserve(s.target))})},a);d.observe(e)}function ue(){const e=document.getElementById("hero-loop-video");if(!e)return;const o={root:null,threshold:.1};new IntersectionObserver(n=>{n.forEach(r=>{r.isIntersecting?e.play().catch(()=>{}):e.pause()})},o).observe(e)}function me(){const e=document.getElementById("enhanced-contact-form");if(!e)return;const o=document.getElementById("contact-submit-btn"),t=document.getElementById("contact-btn-text"),n=document.getElementById("contact-btn-icon"),r=document.getElementById("contact-success"),a=document.getElementById("contact-error");e.addEventListener("submit",async d=>{d.preventDefault(),o&&(o.disabled=!0),t&&(t.textContent="Sending..."),n&&n.classList.add("animate-pulse"),r&&r.classList.add("hidden"),a&&a.classList.add("hidden");try{const i=new FormData(e);(await fetch(e.action,{method:"POST",body:i,headers:{Accept:"application/json"}})).ok?(e.reset(),r&&r.classList.remove("hidden"),t&&(t.textContent="Sent!")):(a&&a.classList.remove("hidden"),t&&(t.textContent="Send message"),o&&(o.disabled=!1))}catch{a&&a.classList.remove("hidden"),t&&(t.textContent="Send message"),o&&(o.disabled=!1)}finally{n&&n.classList.remove("animate-pulse")}})}function pe(){const e=document.getElementById("hero-loop-video"),o=document.getElementById("video-sound-toggle"),t=document.getElementById("video-sound-off"),n=document.getElementById("video-sound-on");!e||!o||o.addEventListener("click",r=>{r.stopPropagation();const a=e.muted;e.muted=!a,e.muted?(t.classList.remove("hidden"),n.classList.add("hidden")):(t.classList.add("hidden"),n.classList.remove("hidden"))})}function fe(){const e=document.getElementById("hero-loop-video"),o=document.getElementById("video-play-toggle"),t=document.getElementById("video-pause-icon"),n=document.getElementById("video-play-icon");!e||!o||(o.addEventListener("click",r=>{r.stopPropagation(),e.paused?e.play().then(()=>{t.classList.remove("hidden"),n.classList.add("hidden")}).catch(a=>{console.error("Video play failed:",a)}):(e.pause(),t.classList.add("hidden"),n.classList.remove("hidden"))}),e.addEventListener("play",()=>{t.classList.remove("hidden"),n.classList.add("hidden")}),e.addEventListener("pause",()=>{t.classList.add("hidden"),n.classList.remove("hidden")}))}function he(){const e=document.getElementById("about-portrait-wrapper");e&&e.addEventListener("click",()=>{e.classList.toggle("touch-active")})}let C=null;function B(){if(C)return C;const e=localStorage.getItem("sb_url")||"https://iyhynpndndgxyioojdwp.supabase.co",o=localStorage.getItem("sb_key")||"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml5aHlucG5kbmRneHlpb29qZHdwIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODA5NDg4MTksImV4cCI6MjA5NjUyNDgxOX0.QrDi0n3i-Et4EUabbPU6dtn9A-g35xDm3Ogv22jzXe4";if(window.supabase)try{return C=window.supabase.createClient(e,o),C}catch(t){console.error("Supabase client failed to initialize:",t)}return null}async function ge(){const e=B();if(e){const{data:t,error:n}=await e.from("projects").select("*").order("created_at",{ascending:!1});if(!n)return t}const o=localStorage.getItem("db_projects");return o?JSON.parse(o):[]}async function be(){const e=B();if(e){const{data:t,error:n}=await e.from("testimonials").select("*").order("created_at",{ascending:!1});if(!n)return t}const o=localStorage.getItem("db_testimonials");return o?JSON.parse(o):[]}async function ve(){const e=B();if(e){const{data:t,error:n}=await e.from("about_me").select("*").eq("key","profile_info").single();if(!n&&t)return t.value}const o=localStorage.getItem("db_about_me");return o?JSON.parse(o):null}async function ye(){const e=B();if(e){const{data:t,error:n}=await e.from("blogs").select("*").order("created_at",{ascending:!1});if(!n)return t}const o=localStorage.getItem("db_blogs");return o?JSON.parse(o):[]}async function we(){const e=await ge();if(e&&e.length>0){const a=document.getElementById("projects-showcase-grid");a&&(a.innerHTML="",e.forEach(s=>{const c=(s.tags||[]).map(u=>`<span class="rounded-full border hairline px-2.5 py-1">${u}</span>`).join(""),p=s.image_url?`<img src="${s.image_url}" class="w-full h-full object-cover filter brightness-[0.95] group-hover:scale-[1.03] transition duration-500" alt="${s.title} screen">`:`<div class="w-full h-full bg-gradient-to-br from-primary/5 to-primary/20 flex items-center justify-center font-display text-3xl font-semibold text-primary/30 select-none">${s.title.substring(0,2).toUpperCase()}</div>`,l=document.createElement("a");l.href=s.link||"#",l.target="_blank",l.className="group block rounded-2xl border hairline overflow-hidden transition hover:shadow-lg md:col-span-4",l.innerHTML=`
        ...
        ${t.bio2?`<p>${t.bio2}</p>`:""}
      `)}const n=await ye(),r=document.getElementById("changelog-container");r&&(n&&n.length>0?(r.innerHTML="",n.forEach(a=>{let d="bg-primary/10 text-primary border border-primary/20";a.status==="Published"&&(d="bg-emerald-500/10 text-emerald-400 border border-emerald-500/20"),a.status==="Draft"&&(d="bg-amber-500/10 text-amber-400 border border-amber-500/20");const i=document.createElement("article");i.className="p-6 rounded-2xl border hairline bg-foreground/[0.02] flex flex-col items-start gap-4 text-left w-full";const s=a.created_at?new Date(a.created_at).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}):"";i.innerHTML=`
